              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    maxLines: 5,
                    decoration: InputDecoration(helper: Text('This is guidance for the AI model. Telling it what kind of article you prefer to prioritize for the scoring  of each article. The change only applies to future articles.')),
                  ),
                  Gap(8),
                  Align(
