...
_LayoutBlock _$LayoutBlockFromJson(Map<String, dynamic> json) => _LayoutBlock(
  ...
  settings: json['settings'] == null ? null : LayoutBlockSettings.fromJson(json['settings'] as Map<String, dynamic>),
);

Map<String, dynamic> _$LayoutBlockToJson(_LayoutBlock instance) => <String, dynamic>{
  'id': instance.id,
...
const _$LayoutBlockTypesEnumMap = {
  ...
  LayoutBlockTypes.bigHeadlinePicture: 'bigHeadlinePicture',
  LayoutBlockTypes.bigGridPicture: 'bigGridPicture',
  LayoutBlockTypes.searchResult: 'searchResult',
};
