...
mixin _$OpenaiUsageState {
 ...
 OpenAiUsageStats? get relevance; OpenAiUsageStats? get shortening; bool get loading; UsagePeriod get period; dynamic get error; StackTrace? get stackTrace;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OpenaiUsageState&&(identical(other.relevance, relevance) || other.relevance == relevance)&&(identical(other.shortening, shortening) || other.shortening == shortening)&&(identical(other.loading, loading) || other.loading == loading)&&(identical(other.period, period) || other.period == period)&&const DeepCollectionEquality().equals(other.error, error)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}


@override
int get hashCode => Object.hash(runtimeType,relevance,shortening,loading,period,const DeepCollectionEquality().hash(error),stackTrace);

@override
String toString() {
  return 'OpenaiUsageState(relevance: $relevance, shortening: $shortening, loading: $loading, period: $period, error: $error, stackTrace: $stackTrace)';
}
...
@useResult
$Res call({
 OpenAiUsageStats? relevance, OpenAiUsageStats? shortening, bool loading, UsagePeriod period, dynamic error, StackTrace? stackTrace
});
...
/// Create a copy of OpenaiUsageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? relevance = freezed,Object? shortening = freezed,Object? loading = null,Object? period = null,Object? error = freezed,Object? stackTrace = freezed,}) {
...
as bool,period: null == period ? _self.period : period // ignore: cast_nullable_to_non_nullable
as UsagePeriod,error: freezed == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( OpenAiUsageStats? relevance,  OpenAiUsageStats? shortening,  bool loading,  UsagePeriod period,  dynamic error,  StackTrace? stackTrace)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OpenaiUsageState() when $default != null:
return $default(_that.relevance,_that.shortening,_that.loading,_that.period,_that.error,_that.stackTrace);case _:
  return orElse();

}
}

@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( OpenAiUsageStats? relevance,  OpenAiUsageStats? shortening,  bool loading,  UsagePeriod period,  dynamic error,  StackTrace? stackTrace)  $default,) {final _that = this;
switch (_that) {
case _OpenaiUsageState():
return $default(_that.relevance,_that.shortening,_that.loading,_that.period,_that.error,_that.stackTrace);}
}

@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( OpenAiUsageStats? relevance,  OpenAiUsageStats? shortening,  bool loading,  UsagePeriod period,  dynamic error,  StackTrace? stackTrace)?  $default,) {final _that = this;
switch (_that) {
case _OpenaiUsageState() when $default != null:
return $default(_that.relevance,_that.shortening,_that.loading,_that.period,_that.error,_that.stackTrace);case _:
  return null;
...
class _OpenaiUsageState implements OpenaiUsageState, WithError {
  const _OpenaiUsageState({this.relevance, this.shortening, this.loading = false, this.period = UsagePeriod.month, this.error, this.stackTrace});


@override final  OpenAiUsageStats? relevance;
@override final  OpenAiUsageStats? shortening;
@override@JsonKey() final  bool loading;
@override@JsonKey() final  UsagePeriod period;
...
/// Create a copy of OpenaiUsageState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? relevance = freezed,Object? shortening = freezed,Object? loading = null,Object? period = null,Object? error = freezed,Object? stackTrace = freezed,}) {
