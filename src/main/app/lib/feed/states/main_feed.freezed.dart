...
mixin _$MainFeedState {
 ...
 bool get hasScrolled; DateTime get currentTime; TimeBlock get timeBlock; bool get loading; Map<DateTimeRange, TimeBlockFeed> get items; bool get searchMode; String get searchTerms; List<FeedItem> get searchResults; int get searchPage; dynamic get error; StackTrace? get stackTrace;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MainFeedState&&(identical(other.hasScrolled, hasScrolled) || other.hasScrolled == hasScrolled)&&(identical(other.currentTime, currentTime) || other.currentTime == currentTime)&&(identical(other.timeBlock, timeBlock) || other.timeBlock == timeBlock)&&(identical(other.loading, loading) || other.loading == loading)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.searchMode, searchMode) || other.searchMode == searchMode)&&(identical(other.searchTerms, searchTerms) || other.searchTerms == searchTerms)&&const DeepCollectionEquality().equals(other.searchResults, searchResults)&&(identical(other.searchPage, searchPage) || other.searchPage == searchPage)&&const DeepCollectionEquality().equals(other.error, error)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}


@override
int get hashCode => Object.hash(runtimeType,hasScrolled,currentTime,timeBlock,loading,const DeepCollectionEquality().hash(items),searchMode,searchTerms,const DeepCollectionEquality().hash(searchResults),searchPage,const DeepCollectionEquality().hash(error),stackTrace);

@override
String toString() {
  return 'MainFeedState(hasScrolled: $hasScrolled, currentTime: $currentTime, timeBlock: $timeBlock, loading: $loading, items: $items, searchMode: $searchMode, searchTerms: $searchTerms, searchResults: $searchResults, searchPage: $searchPage, error: $error, stackTrace: $stackTrace)';
}
...
@useResult
$Res call({
 bool hasScrolled, DateTime currentTime, TimeBlock timeBlock, bool loading, Map<DateTimeRange, TimeBlockFeed> items, bool searchMode, String searchTerms, List<FeedItem> searchResults, int searchPage, dynamic error, StackTrace? stackTrace
});
...
/// Create a copy of MainFeedState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hasScrolled = null,Object? currentTime = null,Object? timeBlock = null,Object? loading = null,Object? items = null,Object? searchMode = null,Object? searchTerms = null,Object? searchResults = null,Object? searchPage = null,Object? error = freezed,Object? stackTrace = freezed,}) {
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool hasScrolled,  DateTime currentTime,  TimeBlock timeBlock,  bool loading,  Map<DateTimeRange, TimeBlockFeed> items,  bool searchMode,  String searchTerms,  List<FeedItem> searchResults,  int searchPage,  dynamic error,  StackTrace? stackTrace)  $default,) {final _that = this;
switch (_that) {
case _MainFeedState():
return $default(_that.hasScrolled,_that.currentTime,_that.timeBlock,_that.loading,_that.items,_that.searchMode,_that.searchTerms,_that.searchResults,_that.searchPage,_that.error,_that.stackTrace);}
}
...
@override
int get hashCode => Object.hash(runtimeType,hasScrolled,currentTime,timeBlock,loading,const DeepCollectionEquality().hash(_items),searchMode,searchTerms,const DeepCollectionEquality().hash(_searchResults),searchPage,const DeepCollectionEquality().hash(error),stackTrace);
...
/// Create a copy of MainFeedState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? hasScrolled = null,Object? currentTime = null,Object? timeBlock = null,Object? loading = null,Object? items = null,Object? searchMode = null,Object? searchTerms = null,Object? searchResults = null,Object? searchPage = null,Object? error = freezed,Object? stackTrace = freezed,}) {
