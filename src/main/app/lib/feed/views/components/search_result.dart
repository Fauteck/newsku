    ...
    return Padding(
      ...
      child: ClickableFeedItem(
        ...
        child: Row(
          ...
          children: [
            FeedItemImage(item: item, width: 100, height: 100, borderRadius: .circular(10)),
            Gap(32),
            Expanded(
              child: Column(
                ...
                spacing: 8,
                children: [
                  Text(item.title ?? '', style: textTheme.headlineSmall, maxLines: 2, overflow: .ellipsis),
                  ItemContent(item: item, maxLines: 3, overflow: .ellipsis),
                  InfoBar(item: item),
                ],
              ),
            ),
